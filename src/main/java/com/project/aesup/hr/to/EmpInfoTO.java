package com.project.aesup.hr.to;
...
public class EmpInfoTO extends BaseTO {
	...
	public List<EmployeeDetailTO> getEmpDetailTOList() {
		return empDetailTOList;
	}

	public void setEmpDetailTOList(List<EmployeeDetailTO> empDetailTOList) {
		this.empDetailTOList = empDetailTOList;
	}

	public List<EmployeeSecretTO> getEmpSecretTOList() {
		return empSecretTOList;
	}

	public void setEmpSecretTOList(List<EmployeeSecretTO> empSecretTOList) {
